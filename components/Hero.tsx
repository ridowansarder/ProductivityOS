...
const Hero = () => {
  return (
    <main className="max-w-6xl mx-auto flex-1 flex flex-col items-center justify-center px-6 py-16">
      ...
      <div className="grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 px-4 pt-8 text-left w-full">
        <Card>
          <CardHeader>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Keep notes alongside courses and link them to assignments when
              needed.
            </CardDescription>
          </CardHeader>
        </Card>
        <Card>
          <CardHeader>
            <CardTitle>AI-Ready by Design</CardTitle>
            <CardDescription>
              AI features like weekly summaries and assignment breakdowns are
              easy to access.
            </CardDescription>
          </CardHeader>
        </Card>
